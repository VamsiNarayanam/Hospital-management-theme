(function () {
  ...
  var tickColor = "#7A9199";
  var gridColor = "rgba(43, 127, 212, 0.08)";
  var accent = "#2B7FD4";
  var accentSoft = "rgba(43, 127, 212, 0.15)";
  ...
  function initDashboardUser() {
    ...
    if (orgLabel && !document.body.classList.contains("dashboard-page--client") && !document.body.classList.contains("dashboard-page--customer")) {
      orgLabel.textContent = "Stackly Hospital Management";
    }
  ...
  function initAdminCharts() {
    ...
    new Chart(elRevenue, {
      ...
      data: {
        ...
        datasets: [
          {
            label: "Weekly hospital revenue (₹)",
            data: [182000, 214000, 198000, 241000, 268000, 312000, 289000],
            borderColor: accent,
